    ...
    <div className="max-w-3xl mx-auto px-6 py-8">
      <div className="mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-bold tracking-tight" style={{ color: "var(--text)" }}>Tarefas</h1>
        </div>
      </div>
        ...
        <ul className="divide-y" style={{ borderColor: "var(--border)" }}>
          {state.tasks.length === 0 ? (
            ...
            state.tasks.map((task) => {
              ...
              return (
                <li key={task.id} className="p-4 flex items-center justify-between gap-4 hover:bg-[var(--card-hover)] transition-colors">
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <span className={`text-sm ${isDone ? "line-through opacity-50" : ""}`} style={{ color: "var(--text)" }}>
                      {task.title}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button onClick={() => handleDelete(task.id)} className="p-1 text-red-400 hover:text-red-300">
                      <Trash2 size={16} />
                    </button>
                  </div>
                </li>
